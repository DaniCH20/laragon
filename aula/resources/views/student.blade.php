                ...
                <thead>
                    <tr>
                        <a href="{{ route('students.create') }}" role="button"><button type="button" class="crear"
                                data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-plus-lg">Insertar Nuevo
                                    Alumno</i></button></a>
                    </tr>
                    <tr>
                        <th>Ver</th>
                            ...
                            <td>
                                <form action="{{ route('students.destroy', $student->id) }}" method="POST">
                                    ...
                                    <button class="btn btn-danger" type="submit"
                                        onclick="return confirm('¿Estás seguro de que quieres eliminar a {{ $student->nombre_apellido }}?')">Eliminar</button>
                                </form>
                            </td>
                        </tr>
                    @endforeach
